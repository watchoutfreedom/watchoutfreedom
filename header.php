...
<header class="header">
  <div class="header__content">
    ...
    <!-- 
      <a href="<?php bloginfo(wpurl); ?>" class="header__link header__link--active">
        Projects
      </a>
      <a href="<?php bloginfo(wpurl); ?>/about" class="header__link">
        About
      </a>
      <a href="<?php bloginfo(wpurl); ?>/contact" class="header__link">
        Write us
      </a>
    -->
    </nav>
